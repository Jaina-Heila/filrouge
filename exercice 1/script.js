...
// //   (indice : utiliser une condition simple avec if / else)
 ...
 let shopName="je suis";
 let city= "Lyon";
 let isopen= "true"
 let productCount= 30;
 let slogan = "i am strong";


 console.log(shopName);
 let message="cest ouvert";
...
let welcomeMessage= "Bienvenue sur " + shopName+ " à "+city;
...
let welcomeMessage2=`Bienvenur sur ${shopName} à ${city}`;
...
console.log(slogan.replace("strong", "pretty"));
